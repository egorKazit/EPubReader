...
public final class ActivityResultLauncherWrapper {
     ...
     */
    public static <I, O> ActivityResultLauncher<I> getLauncher(@NonNull BiFunction<ActivityResultContract<I, O>, ActivityResultCallback<O>, ActivityResultLauncher<I>> register,
