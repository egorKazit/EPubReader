...
public enum ContentViewerWebViewResourceEnum {
    ...
    HTML_TEXT_FONT_HEADER("<head>", "<style>@font-face {font-family: 'arden'; src: url('qk-e-book-file://localhost/fonts/%s');}body {font-family: 'arden';}</style>"),
    HTML_TEXT_FONT_BODY("<body", "<body style=\"font-family: arden\"");
